export default function checkActivityFunctionsApi() {
  ...
  describe(`checkActivityFunctionsApi`, () => {
    ...
    beforeAll(() => {
      elrondSpa.registerApplication('test1', () => Promise.resolve(dummyApp1), activityFunctions[1])
      elrondSpa.registerApplication('test2', () => Promise.resolve(dummyApp2), activityFunctions[2])
    })
