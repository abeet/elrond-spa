 ...
 * elrond-spa has ensured that the correct applications are
...
export function navigateToUrl(obj, opts={}) {
  ...
  if (typeof obj === 'string') {
    ...
    throw new Error(`elrondSpaNavigate must be either called with a string url, with an <a> tag as its context, or with an event whose currentTarget is an <a> tag`);
  }
 ...
 */
window.elrondSpaNavigate = navigateToUrl;
