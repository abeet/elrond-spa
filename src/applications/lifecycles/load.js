...
export async function toLoadPromise(app) {
  ...
  try {
    ...
    if (!smellsLikeAPromise(loadPromise)) {
      ...
      throw new Error(`elrond-spa loading function did not return a promise. Check the second argument to registerApplication('${app.name}', loadingFunction, activityFunction)`);
    }
