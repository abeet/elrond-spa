...
export function registerApplication(appName, arg1, arg2) {
  ...
  if (!arg2) {
    if (!Loader) {
      throw new Error(`You cannot declare a elrond-spa application without either providing a way to load the application or a Loader. See https://github.com/abeet/elrond-spa/blob/master/docs/elrond-spa-api.md#declareApplication`);
    }
